      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${
                selectedCategory === category
                  ...
                  : "bg-background/40 border border-white/20 text-muted-foreground hover:border-primary/50"
              }`}
            >
              {category}
            </button>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredResources.map((resource, index) => (
            ...
            >
              <Card className="h-full p-6 bg-background/40 backdrop-blur-xl border-white/20 hover:border-primary/50 transition-all duration-300 hover:shadow-xl group">
