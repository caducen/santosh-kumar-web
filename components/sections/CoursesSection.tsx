          ...
          {courses.map((course, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <Card className="relative h-full p-8 bg-white border-2 transition-all duration-300 overflow-hidden rounded-lg flex flex-col shadow-lg hover:border-gold hover:shadow-2xl hover:shadow-gold/30">
                {/* Level Badge */}
                <div className="mb-4">
                  <span
