...
function AnimatedStatCard({ label, value, index, isVisible }: AnimatedStatCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        <Card className="relative p-6 text-center bg-white border-2 border-gold/30 transition-all duration-300 overflow-hidden rounded-lg shadow-lg hover:border-gold hover:shadow-2xl hover:shadow-gold/30">
        <motion.div
